...
IMPLEMENT_CLIENTCLASS_DT( C_SDK_PropJeep, DT_SDK_PropJeep, CSDK_PropJeep )
...
bool C_SDK_PropJeep::Simulate( void )
{
...
//-----------------------------------------------------------------------------
void C_SDK_PropJeep::UpdateViewAngles( C_BasePlayer *pLocalPlayer, CUserCmd *pCmd )
{
...
// Purpose:
//-----------------------------------------------------------------------------
void C_SDK_PropJeep::DampenEyePosition( Vector &vecVehicleEyePos, QAngle &vecVehicleEyeAngles )
{
...
//-----------------------------------------------------------------------------
void C_SDK_PropJeep::ComputePDControllerCoefficients( float *pCoefficientsOut,
...
// Purpose:
//-----------------------------------------------------------------------------
void C_SDK_PropJeep::DampenForwardMotion( Vector &vecVehicleEyePos, QAngle &vecVehicleEyeAngles, float flFrameTime )
{
...
// Purpose:
//-----------------------------------------------------------------------------
void C_SDK_PropJeep::DampenUpMotion( Vector &vecVehicleEyePos, QAngle &vecVehicleEyeAngles, float flFrameTime )
{
	// Get up vector.
	Vector vecUp;
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_SDK_PropJeep::OnEnteredVehicle( C_BasePlayer *pPlayer )
{
	int eyeAttachmentIndex = LookupAttachment( "vehicle_driver_eyes" );
	Vector vehicleEyeOrigin;
	QAngle vehicleEyeAngles;
